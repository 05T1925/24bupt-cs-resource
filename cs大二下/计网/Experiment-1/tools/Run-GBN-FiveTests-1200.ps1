param(
    ...
    [string]$OutPrefix = "gbn-performance-tests"
)
...
"GBN performance tests" | Set-Content -LiteralPath $Manifest -Encoding UTF8
"Duration per test: $DurationSeconds seconds" | Add-Content -LiteralPath $Manifest -Encoding UTF8
"Executable: $Exe" | Add-Content -LiteralPath $Manifest -Encoding UTF8
"Started: $((Get-Date).ToString("o"))" | Add-Content -LiteralPath $Manifest -Encoding UTF8

$BasePort = Get-Random -Minimum 64200 -Maximum 65000
...
"Ended: $((Get-Date).ToString("o"))" | Add-Content -LiteralPath $Manifest -Encoding UTF8
